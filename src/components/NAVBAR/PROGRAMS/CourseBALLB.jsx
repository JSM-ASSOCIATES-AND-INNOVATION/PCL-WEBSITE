                ...
                <table className="w-full text-left whitespace-nowrap md:whitespace-normal">
                  ...
                  <tbody className="bg-[#050505]">
                    <tr className="hover:bg-[#1a1a1a] transition-colors border-b border-white/5">
                      ...
                      <td className="p-4 text-gray-400 text-sm">Political Science, Sociology, Economics, English, Law of Contracts, Torts.</td>
                    </tr>
                    <tr className="hover:bg-[#1a1a1a] transition-colors border-b border-white/5">
                      <td className="p-4 text-gray-300 font-semibold">Years 3 & 4 (Core Law)</td>
                      <td className="p-4 text-gray-400 text-sm">Constitutional Law, Criminal Law, Family Law, Property Law, Environmental Law.</td>
                    </tr>
                    <tr className="hover:bg-[#1a1a1a] transition-colors">
                      <td className="p-4 text-gray-300 font-semibold">Year 5 (Clinical & Advanced)</td>
                      <td className="p-4 text-gray-400 text-sm">Moot Court, Drafting & Pleading, Public International Law, Human Rights, Professional Ethics.</td>
                    </tr>
                  </tbody>
                </table>
              </div>
