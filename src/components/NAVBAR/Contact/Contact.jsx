...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen w-full relative bg-[#050505] text-white pb-20">
      {/* Background Elements */}
      ...
      <div className="relative z-20 pt-32 px-6 md:px-12 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          ...
          <motion.div 
            ...
            className="space-y-8"
          >
            <h2 className="text-2xl font-bold text-white mb-6 uppercase tracking-wider" style={{ fontFamily: "'Playfair Display', serif" }}>
              Contact Information
            </h2>
            ...
            <div className="flex items-start space-x-6">
              ...
              <div>
                <h4 className="text-lg font-bold text-white mb-1">Campus Address</h4>
            ...
            <div className="flex items-start space-x-6">
              ...
              <div>
                ...
                <p className="text-gray-400 leading-relaxed">+91 8599000777</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-6">
              ...
              <div>
                ...
                <a href="mailto:info@prudentiacollegeoflaw.com" className="text-gray-400 hover:text-[#FFBF00] transition-colors leading-relaxed">
            ...
            <div className="flex items-start space-x-6">
              ...
              <div>
                <h4 className="text-lg font-bold text-white mb-1">College Timings</h4>
                <p className="text-gray-400 leading-relaxed">Monday – Saturday: 9:00 AM – 4:00 PM</p>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div 
            ...
            className="bg-[#111] border border-white/5 p-8 rounded-xl relative overflow-hidden"
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <input 
                  ...
                  required
                  className="w-full bg-[#0a0a0a] border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[#FFBF00] transition-colors"
              ...
              <div>
                <label htmlFor="subject" className="block text-sm text-gray-400 mb-2">Subject / Program of Interest</label>
                <select 
                  id="subject" 
                  name="subject" 
                  value={formData.subject}
                  onChange={handleChange}
                  className="w-full bg-[#0a0a0a] border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[#FFBF00] transition-colors appearance-none"
                >
              ...
              <div>
                ...
                <textarea 
                  ...
                  required
                  rows="4"
                  className="w-full bg-[#0a0a0a] border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[#FFBF00] transition-colors resize-none"
              ...
              <button 
                type="submit"
                className="w-full flex items-center justify-center space-x-2 bg-[#FFBF00] hover:bg-[#e5aa00] text-black font-bold uppercase tracking-widest py-4 rounded-lg transition-colors mt-4"
              >
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-bold text-white uppercase tracking-wider" style={{ fontFamily: "'Playfair Display', serif" }}>
              Campus Location
            </h2>
            <a 
              ...
              target="_blank" 
              rel="noreferrer"
              className="text-sm text-[#FFBF00] hover:text-white transition-colors flex items-center space-x-2 font-bold uppercase tracking-widest"
            >
