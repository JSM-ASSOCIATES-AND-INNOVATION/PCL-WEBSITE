...
export default function AdminAcademicHub() {
    ...
    const tabs = {
        planning: [
            ...
            { id: "system_settings", label: "Global Settings", icon: "fa-sliders" }
        ],
        success: [
            ...
            <div className={`w-full relative overflow-hidden rounded-[2rem] shadow-2xl p-6 lg:p-8 flex flex-col gap-6 border border-white/5 bg-gradient-to-r from-themeAccent to-themeAccent/80`}>
                ...
                <div className="flex items-center gap-4 lg:gap-5 relative z-10">
                    <div className="w-14 h-14 lg:w-16 lg:h-16 rounded-[1rem] bg-black/20 backdrop-blur-md border border-black/10 dark:border-white/20 flex items-center justify-center shrink-0 shadow-lg">
                        <i className="fa-solid fa-graduation-cap text-white text-2xl lg:text-3xl drop-shadow-sm dark:drop-shadow-md"></i>
                    </div>
                    <div>
                        ...
                        <h1 className={`${theme.text.heading} text-2xl lg:text-3xl tracking-tight text-white mb-1 drop-shadow-sm dark:drop-shadow-md`}>Academic Center</h1>
                ...
                <div className="flex flex-col gap-3 relative z-10">
                    ...
                    {/* Line 2: Sub-Modules */}
                    <div className="flex flex-wrap lg:flex-nowrap p-1.5 bg-black/20 backdrop-blur-md rounded-2xl border border-black/10 dark:border-white/20 gap-1.5 w-fit max-w-full overflow-x-auto no-scrollbar">
