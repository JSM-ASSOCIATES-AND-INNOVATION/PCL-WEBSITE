...
export default function SMMessages() {
    return (
        <div className="flex flex-col gap-6 animate-fade-in">
            <div className="bg-themePanel border-[length:var(--border-width)] border-themeBorder rounded-themePanel p-8 text-center opacity-70">
                <i className="fa-solid fa-comments text-4xl text-blue-500 mb-4"></i>
                <h2 className={`${theme.text.heading} text-lg text-themeText`}>Mentor Messages</h2>
