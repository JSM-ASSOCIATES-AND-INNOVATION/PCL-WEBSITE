...
export default function SMResearch() {
    return (
        <div className="flex flex-col gap-6 animate-fade-in">
            <div className="bg-themePanel border-[length:var(--border-width)] border-themeBorder rounded-themePanel p-8 text-center opacity-70">
                <i className="fa-solid fa-microscope text-4xl text-purple-500 mb-4"></i>
                <h2 className={`${theme.text.heading} text-lg text-themeText`}>Research & Publications</h2>
