    ...
    return (
        <div className="flex flex-col gap-6 animate-fade-in pb-10">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <button onClick={() => setActiveTab('allocations')} className="bg-themePanel border-[length:var(--border-width)] border-themeBorder rounded-themePanel p-4 lg:p-6 flex flex-col items-center justify-center gap-3 hover:border-indigo-500 hover:shadow-[0_0_20px_rgba(99,102,241,0.2)] transition-all group active:scale-95">
                ...
                <button onClick={() => setActiveTab('transfers')} className="bg-themePanel border-[length:var(--border-width)] border-themeBorder rounded-themePanel p-4 lg:p-6 flex flex-col items-center justify-center gap-3 hover:border-amber-500 hover:shadow-[0_0_20px_rgba(245,158,11,0.2)] transition-all group active:scale-95">
                ...
                <button onClick={() => setActiveTab('transfers')} className="bg-themePanel border-[length:var(--border-width)] border-themeBorder rounded-themePanel p-4 lg:p-6 flex flex-col items-center justify-center gap-3 hover:border-emerald-500 hover:shadow-[0_0_20px_rgba(16,185,129,0.2)] transition-all group active:scale-95">
                ...
                <button onClick={() => setActiveTab('allocations')} className="bg-themePanel border-[length:var(--border-width)] border-themeBorder rounded-themePanel p-4 lg:p-6 flex flex-col items-center justify-center gap-3 hover:border-blue-500 hover:shadow-[0_0_20px_rgba(59,130,246,0.2)] transition-all group active:scale-95">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-themePanel border-[length:var(--border-width)] border-themeBorder rounded-themePanel p-6 shadow-sm">
                    ...
                    {stats.loading ? (
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="w-full h-2.5 bg-themeElevated rounded-full overflow-hidden border-[length:var(--border-width)] border-themeBorderStrong shadow-inner">
                                <div 
                            ...
                            <div className="grid grid-cols-2 gap-4 mt-2">
                                <div className="bg-themeElevated p-4 rounded-lg border-[length:var(--border-width)] border-themeBorder">
                ...
                {/* Workload Stats */}
                <div className="bg-themePanel border-[length:var(--border-width)] border-themeBorder rounded-themePanel p-6 shadow-sm flex flex-col">
                    <h3 className={`${theme.text.heading} text-sm tracking-tight text-themeText mb-6 flex items-center justify-between`}>
                    ...
                    {stats.loading ? (
                        ...
                        <div className="flex-1 flex flex-col justify-center gap-5">
                            ...
                            <div className="flex items-center justify-between p-4 rounded-lg bg-themeElevated border-[length:var(--border-width)] border-themeBorder">
                                <div className="flex flex-col">
