...
import legalAidImg from '../../../../ASSETS/CAMPUS/pcl_legal_clinic.webp';
...
export default function LegalAid() {
  ...
  const { content, loading, error } = useSiteContent('/campus/legal-aid', 'legal-aid-clinic');
  ...
  if (error) {
    return (
      <div className={`${styles.pageWrapper} flex flex-col items-center justify-center min-h-screen bg-[var(--bg-color)]`}>
        ...
        <p className="text-[var(--text-muted)] max-w-md text-center relative z-10">Failed to load Legal Aid Clinic content from CMS.</p>
          ...
          <>
            ...
            <div className="mb-16 relative z-10 gsap-fade-up">
              <div className="flex items-center gap-4 mb-6">
                <span className="px-4 py-1 border border-[var(--primary-color)]/30 rounded-full text-[var(--primary-color)] text-sm tracking-widest uppercase bg-[var(--primary-color)]/10 backdrop-blur-sm font-bold">Community Outreach</span>
                <span className="px-4 py-1 border border-[var(--card-border)] rounded-full text-[var(--text-muted)] text-sm tracking-widest uppercase bg-[var(--card-bg)]/30 backdrop-blur-sm font-bold">Experiential Learning</span>
              </div>
              <motion.h1 
              ...
              >
                {content?.heroTitle || 'Legal Aid Clinic'}
              </motion.h1>
            ...
            <div className="w-full h-[400px] md:h-[500px] rounded-3xl overflow-hidden mb-20 relative flex items-center justify-center group shadow-[0_30px_60px_rgba(0,0,0,0.4)] border border-[var(--card-border)] gsap-fade-up z-10">
              <img src={legalAidImg} alt="Legal Aid Clinic" className="w-full h-full object-cover opacity-80 group-hover:opacity-100 group-hover:scale-105 transition-all duration-700" />
            ...
            <div className="mt-24 text-center gsap-fade-up relative z-10 flex flex-col items-center">
              <Link to="/contact" className={styles.magneticBtn} style={{ maxWidth: '300px' }}>
